...
#define LOW_PRECISION`),t}function Jv(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Su?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===af?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Vn&&(t="SHADOWMAP_TYPE_VSM"),t}function Qv(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Cr:case Rr:t="ENVMAP_TYPE_CUBE";break;case Ba:t="ENVMAP_TYPE_CUBE_UV";break}return t}function tx(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Rr:t="ENVMAP_MODE_REFRACTION";break}return t}function ex(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Eu:t="ENVMAP_BLENDING_MULTIPLY";break;case If:t="ENVMAP_BLENDING_MIX";break;case Nf:t="ENVMAP_BLENDING_ADD";break}return t}function nx(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function ix(s,t,e,n){const i=s.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Jv(e),c=Qv(e),h=tx(e),u=ex(e),d=nx(e),f=Wv(e),g=Xv(r),_=i.createProgram();let m,p,M=e.glslVersion?"#version "+e.glslVersion+`
